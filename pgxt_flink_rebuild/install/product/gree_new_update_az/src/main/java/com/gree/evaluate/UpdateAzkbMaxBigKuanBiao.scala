...
import com.gree.model.{AZMaxOrder, WangdianLevel}
...
//待改派
class UpdateAzkbMaxBigKuanBiao extends ProcessFunction[WangdianLevel,AZMaxOrder] {
  override def processElement(value: WangdianLevel, ctx: ProcessFunction[WangdianLevel, AZMaxOrder]#Context, out: Collector[AZMaxOrder]): Unit = {
    //ES链接
    val client: TransportClient = ESTransportPoolUtil.getClient
    val logger: Logger = LoggerFactory.getLogger(UpdateAzkbMaxBigKuanBiao.super.getClass)
    ...
    var wcsj1: String = "null"
    var tbl_Az_Assign_Fkmx :util.ArrayList[util.HashMap[String,String]] =null
    var tbl_Az_Assign_Mx : util.ArrayList[util.HashMap[String,String]] =null
    var tbl_Az_Assign_Satisfaction:util.ArrayList[util.HashMap[String,String]] =null
    var tbl_Az_Assign_Appointment : util.ArrayList[util.HashMap[String,String]] =null
    var tbl_az_assign_fee :util.ArrayList[util.HashMap[String,String]] =null
    var tbl_az_assign_lc_fzry : util.ArrayList[util.HashMap[String,String]] =null
    var tbl_trade_new_for_old:util.ArrayList[util.HashMap[String,String]] =null
    var tbl_yjhx_jdd : util.ArrayList[util.HashMap[String,String]] =null
    ...
    val response: SearchResponse = client
      .prepareSearch("azkb_max_big_kuanbiao_v1")
      .setTypes("_doc")
      .setQuery(QueryBuilders.boolQuery().must(QueryBuilders.termQuery("jspgwdno", value.wdno))
        ...
        .must(QueryBuilders.rangeQuery("stat").lte(1304)))
      .setSize(30000)
      .get()

    val hits: SearchHits = response.getHits
    logger.info("azkb_max_big_kuanbiao_v1符合的数据有" + hits.totalHits + "条")
    ...
    for (hit <- hits) {
      ...
      try {
        ...
        tbl_Az_Assign_Fkmx = hit.getSourceAsMap.get("tbl_Az_Assign_Fkmx").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_Az_Assign_Mx = hit.getSourceAsMap.get("tbl_Az_Assign_Mx").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_Az_Assign_Satisfaction = hit.getSourceAsMap.get("tbl_Az_Assign_Satisfaction").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_Az_Assign_Appointment = hit.getSourceAsMap.get("tbl_Az_Assign_Appointment").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_az_assign_fee = hit.getSourceAsMap.get("tbl_Az_Assign_Fee").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_az_assign_lc_fzry = hit.getSourceAsMap.get("tbl_Az_Assign_Lc_Fzry").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_trade_new_for_old = hit.getSourceAsMap.get("tbl_Trade_New_For_Old").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        tbl_yjhx_jdd = hit.getSourceAsMap.get("tbl_Yjhx_Jdd").asInstanceOf[util.ArrayList[util.HashMap[String, String]]]
        ...
        wcsj1 = hit.getSourceAsMap.get("wcsj1").toString
        platformBizorderid = hit.getSourceAsMap.get("platform_bizorderid").toString
        fkmxLastestMessage = hit.getSourceAsMap.get("fkmx_lastest_message").toString


      } catch {
        case e: Exception => logger.error("UpdateAzkbChangeOrder查azkb_max_big_kuanbiao_v1表异常->" + e.getMessage)
      }

      out.collect(AZMaxOrder(
        ...
        orderphone,extendfiled1,extendfiled2,extendfiled3,extendfiled4,servicewdno,shopno,extendfiled5,tbl_Az_Assign_Fkmx,tbl_Az_Assign_Mx,
        tbl_Az_Assign_Satisfaction,tbl_Az_Assign_Appointment,tbl_az_assign_fee,tbl_az_assign_lc_fzry,tbl_trade_new_for_old,tbl_yjhx_jdd,value.first,
        value.second, value.third, value.fourth, value.fifth, value.sixth, value.seventh,"null","null","null","null","null","null","null",
        appointmentkssj,appointmentjssj,yqwangongtime,organizationaddress,organizationname,wcsj1,platformBizorderid,fkmxLastestMessage))
