...
//将工单及子表所有的数据连接在一起出index
case class AZMaxOrder(
                                  ...
                                  tbl_Az_Assign_Fkmx : util.ArrayList[util.HashMap[String,String]],
                                  tbl_Az_Assign_Mx : util.ArrayList[util.HashMap[String,String]],
                                  tbl_Az_Assign_Satisfaction : util.ArrayList[util.HashMap[String,String]],
                                  tbl_Az_Assign_Appointment : util.ArrayList[util.HashMap[String,String]],
                                  tbl_az_assign_fee:util.ArrayList[util.HashMap[String,String]],
                                  tbl_az_assign_lc_fzry:util.ArrayList[util.HashMap[String,String]],
                                  tbl_trade_new_for_old:util.ArrayList[util.HashMap[String,String]],
                                  tbl_yjhx_jdd:util.ArrayList[util.HashMap[String,String]],
                                  level1:String,
                                  level2:String,
                                  level3:String,
                                  level4:String,
                                  ...
                                  wcsj1:String,
                                  platformBizorderid:String,//店铺交易订单编号
                                  fkmxLastestMessage:String
