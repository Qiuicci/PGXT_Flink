...
import com.gree.func.{Az_Assign_Appointment_ES, Az_Assign_Fee_ES, Az_Assign_Fkmx_ES, Az_Assign_Lc_Fzry_ES, Az_Assign_Lc_Ls_ES, Az_Assign_Mx_ES, Az_Assign_Platform_ES, Az_Assign_Pslc_Ls_ES, Az_Assign_Satisfaction_ES, Check_Exist_Func, Trade_New_For_Old_ES, Yjhx_Jdd_ES}
...
object InstallSync {
  def main(args: Array[String]): Unit = {
    ...
    /**
      ...
      */
    val az_Assign_Lc_Ls_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_AZ_ASSIGN_TOPIC, fsEnv).setParallelism(4)
    //az_Assign_Lc_Ls_Kafka.print("az_Assign_Lc_Ls_Kafka Data->")
    val tblAzAssignLcLsData: DataStream[Tbl_Az_Assign_Lc_Ls] = az_Assign_Lc_Ls_Kafka.process(new Az_Assign_Lc_Ls_ES(tblAzAssignLcLs)).setParallelism(4)
    ...
    /**
      ...
      */
    tblAzAssignLcLsData.addSink(tblAzAssignLcLsESSink.build()).setParallelism(4)
    ...
    /**
      ...
      */
    val az_Assign_Fkmx_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_AZ_ASSIGN_FKMX_TOPIC, fsEnv).setParallelism(4)
    //az_Assign_Fkmx_Kafka.print("az_Assign_Fkmx_Kafka->")
    val azAssignFkmxData: DataStream[Tbl_Az_Assign_Fkmx] = az_Assign_Fkmx_Kafka.process(new Az_Assign_Fkmx_ES(tblAzAssignFkmx)).setParallelism(4)
    ...
    /**
      ...
      */
    azAssignFkmxData.addSink(azAssignFkmxESSink.build()).setParallelism(4)

    /**
      *安装满意度表
      * 消费Tbl_Az_Assign_Satisfaction
      */
    val az_Assign_Satisfaction_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_Az_ASSIGN_SATISFACTION_TOPIC, fsEnv).setParallelism(1)
    //az_Assign_Satisfaction_Kafka.print("az_Assign_Satisfaction_Kafka Data->")
    val azAssignSatisfactionData: DataStream[Tbl_Az_Assign_Satisfaction] = az_Assign_Satisfaction_Kafka.process(new Az_Assign_Satisfaction_ES(tblAzAssignSatisfaction)).setParallelism(1)
    ...
    /**
      ...
      */
    azAssignSatisfactionData.addSink(azAssignSatisfactionESSink.build()).setParallelism(1)

    /**
      * 安装明细表
      * 消费Tbl_Az_Assign_Mx
      */
    val az_Assign_Mx_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_AZ_ASSIGN_MX_TOPIC, fsEnv).setParallelism(4)
    //az_Assign_Mx_Kafka.print("az_Assign_Mx_Kafka Data->")
    val azAssignMxData: DataStream[Tbl_Az_Assign_Mx] = az_Assign_Mx_Kafka.process(new Az_Assign_Mx_ES(tblAzAssignMx)).setParallelism(4)
    ...
    /**
      ...
      */
    azAssignMxData.addSink(azAssignMxESSink.build()).setParallelism(4)
    ...
    /**
      ...
      */
    val trade_New_For_Old_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_TRADE_NEW_FOR_OLD_TOPIC, fsEnv).setParallelism(1)
    //trade_New_For_Old_Kafka.print("Tbl_Trade_New_For_Old Data->")
    val tradeNewForOldData: DataStream[Tbl_Trade_New_For_Old] = trade_New_For_Old_Kafka.process(new Trade_New_For_Old_ES(tblTradeNewForOld)).setParallelism(1)
    ...
    /**
      ...
      */
    tradeNewForOldData.addSink(tradeNewForOldSink.build()).setParallelism(1)
    ...
    /**
      ...
      * 消费Tbl_yjhx_jdd
      */
    val yjhx_Jdd_Kafka = KafkaUtil.getKafkaConnect(Constant.TBL_YJHX_JDD_TOPIC, fsEnv).setParallelism(1)
    //yjhx_Jdd_Kafka.print("Tbl_Yjhx_Jdd Data->")
    val yjhxJddData: DataStream[Tbl_Yjhx_Jdd] = yjhx_Jdd_Kafka.process(new Yjhx_Jdd_ES(tblYjhxJdd)).setParallelism(1)
    ...
    /**Tbl_Yjhx_JddTbl_Trade_New_For_Old
      */
    yjhxJddData.addSink(yjhxJddSink.build()).setParallelism(1)



    var checkazdata:DataStream[(String,String,String,String,String,String)] =
      tblAzAssignLcLsData.getSideOutput(tblAzAssignLcLs).map(a => (Constant.TBL_AZ_ASSIGN_LC_LS, "pgguid", a.pgguid, a.pgguid, a.ts ,a.table)).setParallelism(4) //查询是否已经在es已经存在数据,tblAzAssignLcLsTopic
      ...
      ,azAssignFkmxData.getSideOutput(tblAzAssignFkmx).map(a => (Constant.TBL_AZ_ASSIGN_FKMX, "fkid", a.fkid, a.pgguid, a.ts ,a.table)).setParallelism(4)
      ,azAssignSatisfactionData.getSideOutput(tblAzAssignSatisfaction).map(a => (Constant.TBL_AZ_SATISFACTION, "id", a.id, a.pgguid, a.ts ,a.table)).setParallelism(1)
      ,azAssignMxData.getSideOutput(tblAzAssignMx).map(a => (Constant.TBL_AZ_MX, "pgmxid", a.pgmxid, a.pgguid, a.ts ,a.table)).setParallelism(4)
      ...
      ,tradeNewForOldData.getSideOutput(tblTradeNewForOld).map(a => (Constant.TBL_TRADE_NEW_FOR_OLD, "id", a.id, a.pgguid, a.ts ,a.table)).setParallelism(1)
      ,yjhxJddData.getSideOutput(tblYjhxJdd).map(a => (Constant.TBL_YJHX_JDD, "id", a.id, a.pgguid, a.ts ,a.table)).setParallelism(1)
...
var checkazdata:DataStream[(String,String,String,String,String,String)] = azAssignFkmxData.getSideOutput(tblAzAssignFkmx).map(a => (Constant.TBL_AZ_ASSIGN_FKMX, "fkid", a.fkid, a.pgguid, a.ts ,a.table))
  .union(tblAzAssignLcLsData.getSideOutput(tblAzAssignLcLs).map(a => (Constant.TBL_AZ_ASSIGN_LC_LS, "pgguid", a.pgguid, a.pgguid, a.ts ,a.table)))*/
    ...
    val tblAzAssignLcLsTopic = AsyncDataStream.orderedWait(checkazdata
      ,new AsyncFromES(),5000L,TimeUnit.MILLISECONDS,100).process(new Check_Exist_Func(noExistRecord)).name("返查ES是否有数据")
