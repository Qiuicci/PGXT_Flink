...
//待改派
class UpdateAzkbMaxBigKuanBiaoSale extends ProcessFunction[WangdianLevel,AZMaxOrder] {
  override def processElement(value: WangdianLevel, ctx: ProcessFunction[WangdianLevel, AZMaxOrder]#Context, out: Collector[AZMaxOrder]): Unit = {
    ...
    val logger: Logger = LoggerFactory.getLogger(UpdateAzkbMaxBigKuanBiaoSale.super.getClass)
    ...
    for (hit <- hits) {
      ...
      out.collect(AZMaxOrder(
        ...
        orderphone,extendfiled1,extendfiled2,extendfiled3,extendfiled4,servicewdno,shopno,extendfiled5,tbl_Az_Assign_Fkmx,tbl_Az_Assign_Mx,tbl_Az_Assign_Satisfaction,
        tbl_Az_Assign_Appointment,tbl_az_assign_fee,tbl_az_assign_lc_fzry,tbl_trade_new_for_old,tbl_yjhx_jdd,"null","null","null","null","null","null","null",value.first,
        value.second, value.third, value.fourth, value.fifth, value.sixth, value.seventh,appointmentkssj,appointmentjssj,yqwangongtime,
        organizationaddress,organizationname,wcsj1,platformBizorderid,fkmxLastestMessage))
