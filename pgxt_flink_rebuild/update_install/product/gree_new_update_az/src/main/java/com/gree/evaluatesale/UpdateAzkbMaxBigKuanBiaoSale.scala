  ...
  override def processElement(value: WangdianLevel, ctx: ProcessFunction[WangdianLevel, AZMaxOrder]#Context, out: Collector[AZMaxOrder]): Unit = {
    ...
    for (hit <- hits) {
      ...
      try {
        ...
        case e: Exception => logger.error("UpdateAzkbChangeOrder查azkb_change_orders_v3表异常->" + e.getMessage)
      }
      ...
      out.collect(AZMaxOrder(
        ...
        tbl_Az_Assign_Appointment,"null","null","null","null","null","null","null",value.first,
